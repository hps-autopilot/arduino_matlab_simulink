 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Jun 17 07:02:49 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME IoT
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void IoT_Outputs_wrapper(uint32_T *aX,
			real_T *aY,
			real_T *aZ,
			real_T *gX,
			real_T *gY,
...
{
    uint32_T *aX = (uint32_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *aY = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *aZ = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *gX = (real_T *) ssGetOutputPortRealSignal(S, 3);
    real_T *gY = (real_T *) ssGetOutputPortRealSignal(S, 4);
    real_T *gZ = (real_T *) ssGetOutputPortRealSignal(S, 5);

    IoT_Outputs_wrapper(aX, aY, aZ, gX, gY, gZ);
